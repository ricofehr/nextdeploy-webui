  ...
  technotypesRouter.get('/', function(req, res) {
    res.send({
      "technotypes":[
        ...
        {"id":4,"name":"Database Server","technos":[7]},
        {"id":5,"name":"Nodejs Service","technos":[11,10,9,8]},
        {"id":6,"name":"Messaging Service","technos":[2]},
        {"id":7,"name":"Keyvalue Service","technos":[5,4]},
        {"id":8,"name":"Index Service","technos":[3]},
