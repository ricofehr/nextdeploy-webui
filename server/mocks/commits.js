  ...
  commitsRouter.get('/:id', function(req, res) {
    switch(req.params.id) {
      case '1-master-dda0cdb59073b669f67b0b0e1a6e852a2a8d4218':
        res.send({"commit":{"id":"1-master-dda0cdb59073b669f67b0b0e1a6e852a2a8d4218","commit_hash":"dda0cdb59073b669f67b0b0e1a6e852a2a8d4218","short_id":"dda0cdb5","title":"Init project","author_name":"root","author_email":"admin@example.com","message":"Init project\n","created_at":new Date().toLocaleString(),"branche":"1-master","vms":[2,3,6]}});
        break;
      case '2-master-358077869eafc57a5d1e87bc0c7b17d7a73bac70':
        res.send({"commit":{"id":"2-master-358077869eafc57a5d1e87bc0c7b17d7a73bac70","commit_hash":"358077869eafc57a5d1e87bc0c7b17d7a73bac70","short_id":"35807786","title":"Init project","author_name":"root","author_email":"admin@example.com","message":"Init project\n","created_at":new Date().toLocaleString(),"branche":"2-master","vms":[]}});
        break;
      case '3-master-28fb9dc5ea9bd6a334ef0c25ccf24917396fd1e1':
        res.send({"commit":{"id":"3-master-28fb9dc5ea9bd6a334ef0c25ccf24917396fd1e1","commit_hash":"28fb9dc5ea9bd6a334ef0c25ccf24917396fd1e1","short_id":"28fb9dc5","title":"Init project","author_name":"root","author_email":"admin@example.com","message":"Init project\n","created_at":new Date().toLocaleString(),"branche":"3-master","vms":[]}});
        break;
